            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="mt-1 flex flex-col sm:flex-row sm:flex-wrap sm:mt-0 sm:space-x-6">
                ...
                <div className="mt-2 flex items-center text-sm text-gray-500">
                  ...
                  Location tracking {isAvailable ? 'active' : 'inactive'}
                </div>
              </div>
            </div>
              ...
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    ...
                    <dd className="text-lg font-medium text-gray-900">{stats?.today?.deliveries || 0}</dd>
                  </dl>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    ...
                    <dd className="text-lg font-medium text-gray-900">₹{stats?.today?.earnings || 0}</dd>
                  </dl>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    ...
                    <dd className="text-lg font-medium text-gray-900">{stats?.total?.deliveries || 0}</dd>
                  </dl>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
            ...
            >
              ...
              <div className="mt-8">
                ...
                <p className="mt-2 text-sm text-gray-500">
                  {assignedOrders.length} orders assigned to you
                </p>
              </div>
              <span
                className="pointer-events-none absolute top-6 right-6 text-gray-300 group-hover:text-gray-400"
                      ...
                      <div className="flex items-center">
                        ...
                        <div className="ml-4">
                          ...
                          <div className="text-sm text-gray-500">
                            {order.items?.length || 0} items • {order.deliveryAddress?.city || 'Unknown location'}
                          </div>
                        </div>
                      </div>
                      <div className="flex items-center">
                        ...
                        <Link
                          ...
                          className="ml-2 text-orange-600 hover:text-orange-500 text-sm font-medium"
                        >
                          View Details
                        </Link>
                      </div>
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <dl>
                      ...
                      <dd className="text-lg font-medium text-gray-900">{stats?.weekly?.deliveries || 0} deliveries</dd>
                    </dl>
                  </div>
                </div>
              </div>
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <dl>
                      ...
                      <dd className="text-lg font-medium text-gray-900">{stats?.monthly?.deliveries || 0} deliveries</dd>
                    </dl>
                  </div>
                </div>
              </div>
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-blue-700">
                <ul className="list-disc pl-5 space-y-1">
                  <li>Keep your availability status updated to receive new orders</li>
                  <li>Always verify order details before pickup</li>
                  <li>Maintain good communication with customers</li>
                  <li>Update order status promptly for better tracking</li>
                </ul>
              </div>
            </div>
          </div>
