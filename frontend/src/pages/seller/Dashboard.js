  ...
  const setupSocketConnection = useCallback(() => {
    ...
    socketService.onNewReview((data) => {
      ...
      const reviewNotification = {
        ...
        message: `${reviewData.rating}-star review for "${reviewData.productName}"`,
      ...
      setRecentNotifications(prev => [reviewNotification, ...prev.slice(0, 4)]);
    });
    
    // Continue with the original order notification handling
